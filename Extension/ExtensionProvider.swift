...
class ExtensionDeviceSource: NSObject, CMIOExtensionDeviceSource {
	...
	init(localizedName: String) {
		...
		_streamSource = ExtensionStreamSource(localizedName: "CameraEmulator.Video", streamID: videoID, streamFormat: videoStreamFormat, device: device)
		do {
	...
	func deviceProperties(forProperties properties: Set<CMIOExtensionProperty>) throws -> CMIOExtensionDeviceProperties {
		...
		if properties.contains(.deviceModel) {
			deviceProperties.model = "CameraEmulator Model"
		}
...
class ExtensionProviderSource: NSObject, CMIOExtensionProviderSource {
	...
	init(clientQueue: DispatchQueue?) {
		...
		deviceSource = ExtensionDeviceSource(localizedName: "CameraEmulator (Swift)")
	...
	func providerProperties(forProperties properties: Set<CMIOExtensionProperty>) throws -> CMIOExtensionProviderProperties {
		...
		if properties.contains(.providerManufacturer) {
			providerProperties.manufacturer = "CameraEmulator Manufacturer"
		}
